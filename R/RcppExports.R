...
dRenewalFrankCopula_user <- function(x, y, survX, survY, distParsX, distParsY, extrapolParsX, extrapolParsY, theta, time = 1.0, logFlag = FALSE, nsteps = 100L, extrap = TRUE) {
    .Call('_Countr_dRenewalFrankCopula_user', PACKAGE = 'Countr', x, y, survX, survY, distParsX, distParsY, extrapolParsX, extrapolParsY, theta, time, logFlag, nsteps, extrap)
}
...
dRenewalFrankCopula_bi <- function(x, y, distX, distY, distParsX, distParsY, theta, time = 1.0, logFlag = FALSE, nsteps = 100L, extrap = TRUE) {
    .Call('_Countr_dRenewalFrankCopula_bi', PACKAGE = 'Countr', x, y, distX, distY, distParsX, distParsY, theta, time, logFlag, nsteps, extrap)
}
...
#' @param dist character name of the built-in distribution, see section \sQuote{Details}.
...
dWeibullInterArrivalCountFrankCopula <- function(x, y, shapeX, shapeY, scaleX, scaleY, theta, t, logFlag, jmax, nmax, eps) {
    .Call('_Countr_dWeibullInterArrivalCountFrankCopula', PACKAGE = 'Countr', x, y, shapeX, shapeY, scaleX, scaleY, theta, t, logFlag, jmax, nmax, eps)
}

#' @keywords internal
dWeibullInterArrivalCountFrankCopula_uni <- function(x, y, shapeX, shapeY, scaleX, scaleY, theta, t, logFlag, jmax, nmax, eps) {
    .Call('_Countr_dWeibullInterArrivalCountFrankCopula_uni', PACKAGE = 'Countr', x, y, shapeX, shapeY, scaleX, scaleY, theta, t, logFlag, jmax, nmax, eps)
}
